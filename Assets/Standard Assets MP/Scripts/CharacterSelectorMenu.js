...
function SelectedCharacter1() {
				...
				characterSelected = "Character 1 SELECTED";
...
function SelectedCharacter2() {
				...
				characterSelected = "Character 2 SELECTED";
				PlayerPrefs.SetString("characterSelected", characterSelected);
...
function SelectedCharacter3() {
				...
				characterSelected = "Character 3 SELECTED";
				PlayerPrefs.SetString("characterSelected", characterSelected);
...
function SelectedCharacter4() {
				...
				characterSelected = "Character 4 SELECTED";
				PlayerPrefs.SetString("characterSelected", characterSelected);
